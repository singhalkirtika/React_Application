...
class Contact extends Component {
  ...
  handleSubmit(event){
     ...
     //Default behavior of browser when we submit a form is to got to the next page. We can prevrnt this
  ...
  validate(firstname, lastname, telnum, email){
    const errors = {
     ...
     const reg = /^\d+$/;       // all string of characters should be numbers
     if(this.state.touched.telnum && !reg.test(telnum)){
         errors.telnum = 'Tel. Numver contain only numbers';
     }
